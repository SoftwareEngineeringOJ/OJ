...
urlpatterns = [
    ...
    url(r'^conteststatus/$', 'OJprojectapp.views.contest_status'),
    url(r'^contestrank/$', 'OJprojectapp.views.contest_rank'), 
    
    url(r'^contest_confirm/$', 'OJprojectapp.views.contest_confirm'), 
